...
const Navbar = () => {
  ...
  return (
    <nav className="flex items-center h-20  dark:bg-black bg-opacity-10 justify-between px-4 md:px-8 shadow-md">
      ...
      <div className="flex md:hidden dark:bg-black bg-opacity-10 items-center space-x-4">
      ...
      <div
        className={`absolute top-20 left-0 w-full bg-white dark:bg-black z-40 transition-all duration-300 ease-in-out transform ${isOpen ? "max-h-[300px] opacity-100" : "max-h-0 opacity-0"
